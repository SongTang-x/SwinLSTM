...
def get_args():
    ...
    parser.add_argument('--train_samples', default=10000, type=int, help='Number of samples in training set')
    parser.add_argument('--train_data_dir', default='./data/train-images-idx3-ubyte.gz')
    parser.add_argument('--test_data_dir', default='./data/test_data')
    ...
    parser.add_argument('--epoch_test', default=10, type=int)
    parser.add_argument('--log_train', default=100, type=int)
    parser.add_argument('--log_test', default=10, type=int)
